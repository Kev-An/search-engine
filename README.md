This is a custom search engine built using ReactJS with the Vite development server, the apporach I took for this project was to use three different API's.
